...
public class Add_Employee extends JFrame implements ActionListener {
    ...
    JButton b1, b2;
    String firstname, lastname, dateofbirth, phoneNo, emailId, department, jobtitle, employeeId, salary, hiredate;
    JPanel jp;
    JComboBox bx1, bx2;
    int empId = 0;
    ...
    Add_Employee(){
        ...
        try{
            ...
            String q = "SELECT EmpID FROM IDTracker";
        ...
        if(ae.getActionCommand().equals("Submit")){
            ...
            if(flag == 0 && empt == 0){
                try{
                    ...
                    ConnectionClass obj = new ConnectionClass();
                    String q1 = "INSERT INTO PersonalInformation(FirstName, LastName, Email, PhoneNumber, DateOfBirth) VALUES('"+firstname+"', '"+lastname+"', '"+emailId+"', '"+phoneNo+"', '"+dateofbirth+"');";
                    String q2 = "INSERT INTO JobDetails VALUES("+empId+", '"+jobtitle+"', '"+department+"', '"+hiredate+"');";
                    String q3 = "INSERT INTO SalaryInformation VALUES("+empId+", "+salaryN+", 0);";
                    String q4 = "UPDATE IDTracker SET EmpID = "+empId+";";
                    String q5 = "INSERT INTO LoginDetails VALUES("+empId+", '"+firstname+"1234', 'employee');";
                    System.out.println(empId);
